...
scylla_core = (['message/messaging_service.cc',
                ...
                'replica/querier.cc',
                'replica/log_structured/segment_manager.cc',
                'replica/log_structured/logstor.cc',
                'replica/log_structured/write_buffer.cc',
                'replica/log_structured/compaction.cc',
                'replica/log_structured/rmd160.cc',
